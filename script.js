...
function tempFn() { 
    ...
    result = valInput * 5/4;} 
             ...
             toUnit === "fahrenheit") { 
             result = (valInput * 9/4) + 32;} 
    
             else if (fromUnit === "reamur" && 
             toUnit === "kelvin") { 
             result = valInput * 5/4 + 273;} 
	...
	document.getElementById( 
		"temperatureResult"
	).textContent = `Hasil: ${result.toFixed( 
		2 
)}`;} 
...
function areaFn() { 
	...
	document.getElementById( 
		"areaResult") 
		.textContent = `Hasil: ${result.toFixed(2 
	)} ${toUnit}`;} 
...
function weightFn() { 
	...
	document.getElementById( 
		"weightResult"
	).textContent = `Hasil: ${result.toFixed(1
	)} ${toUnit}`; 
} 
